...
// ── Build a rich financial context for the AI ────────────────────────────────
...
Answer questions about this data honestly. If something looks concerning, say so gently. If asked about things outside this data (e.g. future events you can't know), say so clearly. Keep replies focused — no bullet-point essays unless the user specifically asks for a breakdown.`;
}

// ── Markdown-lite renderer ───────────────────────────────────────────────────
function MessageText({ text, C }) {
  // Bold **text** and newlines only
      ...
      {isEmpty && (
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20, padding: "0 16px" }}>
          <div style={{
            ...
            fontSize: 32, boxShadow: `0 12px 40px ${C.accentGlow}`,
          }}>✦</div>
          <div style={{ textAlign: "center" }}>
            <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 28, color: C.text, margin: "0 0 8px", letterSpacing: "-0.5px" }}>Ask Cove</h2>
            <p style={{ fontSize: 15, color: C.textMuted, margin: 0, lineHeight: 1.5 }}>
              Your finances, explained. Ask anything about<br />your spending, goals, or how to do better.
            </p>
          </div>
